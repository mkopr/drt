...
class Movie(TimeStampedModel):
    ...
    country = models.CharField(max_length=240, null=True, blank=False)
    awards = models.CharField(max_length=240, null=True, blank=False)
    ...
    imdbid = models.CharField(max_length=240, null=True, blank=False)
    typee = models.CharField(max_length=240, null=True, blank=False)  # 'type' is build-in name
    dvd = models.DateField(null=True, blank=False)
    boxoffice = models.CharField(max_length=240, null=True, blank=False)
    production = models.CharField(max_length=240, null=True, blank=False)
